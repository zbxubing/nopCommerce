...
namespace Nop.Plugin.Misc.ExtendedRewardPointsProgram.Infrastructure.Cache
{
        ...
        IConsumer<EntityInserted<ShoppingCartItem>>
    {
        ...
        /// <summary>
        /// Get reward points activating date
        /// </summary>
        /// <param name="settings">Reward points settings</param>
        /// <returns>Date and time or null for the instant activating</returns>
        protected DateTime? GetRewardPointsActivatingDate(RewardPointsSettings settings)
        {
        ...
        public void HandleEvent(BlogCommentApprovedEvent blogCommentEvent)
        {
            ...
            var activatingDate = GetRewardPointsActivatingDate(_rewardPointsSettingsForBlogComments);
            ...
            _rewardPointService.AddRewardPointsHistoryEntry(blogCommentEvent.BlogComment.Customer, _rewardPointsSettingsForBlogComments.Points,
                blogCommentEvent.BlogComment.StoreId, string.Format(message, blogCommentEvent.BlogComment.BlogPost.Title), activatingDate: activatingDate);
        ...
        public void HandleEvent(NewsCommentApprovedEvent newsCommentEvent)
        {
            ...
            //check whether delay is set
            var activatingDate = GetRewardPointsActivatingDate(_rewardPointsSettingsForNewsComments);
            ...
            _rewardPointService.AddRewardPointsHistoryEntry(newsCommentEvent.NewsComment.Customer, _rewardPointsSettingsForNewsComments.Points,
                newsCommentEvent.NewsComment.StoreId, string.Format(message, newsCommentEvent.NewsComment.NewsItem.Title), activatingDate: activatingDate);
        ...
        public void HandleEvent(ProductReviewApprovedEvent productReviewEvent)
        {
            ...
            //check whether delay is set
            var activatingDate = GetRewardPointsActivatingDate(_rewardPointsSettingsForProductReviews);
            ...
            _rewardPointService.AddRewardPointsHistoryEntry(productReviewEvent.ProductReview.Customer, _rewardPointsSettingsForProductReviews.Points,
                productReviewEvent.ProductReview.StoreId, string.Format(message, productName), activatingDate: activatingDate);
        ...
        public void HandleEvent(CustomerRegisteredEvent registeredEvent)
        {
            ...
            //check whether delay is set
            var activatingDate = GetRewardPointsActivatingDate(_rewardPointsForRegistrationSettings);
            ...
            _rewardPointService.AddRewardPointsHistoryEntry(registeredEvent.Customer, _rewardPointsForRegistrationSettings.Points,
                _storeContext.CurrentStore.Id, message, activatingDate: activatingDate);
        }
        ...
        public void HandleEvent(EmailSubscribedEvent subscribedEvent)
        {
            ...
            //check whether delay is set
            var activatingDate = GetRewardPointsActivatingDate(_rewardPointsSettingsForNewsletterSubscriptions);
            ...
            _rewardPointService.AddRewardPointsHistoryEntry(customer, _rewardPointsSettingsForNewsletterSubscriptions.Points,
                subscribedEvent.Subscription.StoreId, message, activatingDate: activatingDate);
        ...
        public void HandleEvent(OrderPaidEvent orderPaidEvent)
        {
            ...
            if (_rewardPointsSettingsForFirstPurchase.IsEnabled)
            {
                ...
                //check whether delay is set
                var activatingDate = GetRewardPointsActivatingDate(_rewardPointsSettingsForFirstPurchase);
                ...
                _rewardPointService.AddRewardPointsHistoryEntry(orderPaidEvent.Order.Customer, _rewardPointsSettingsForFirstPurchase.Points,
                    orderPaidEvent.Order.StoreId, message, activatingDate: activatingDate);
            }
            ...
            if (_rewardPointsSettingsForFastPurchase.IsEnabled)
            {
                ...
                //check whether delay is set
                var activatingDate = GetRewardPointsActivatingDate(_rewardPointsSettingsForFastPurchase);
