...
namespace Nop.Plugin.Tax.FixedOrByCountryStateZip.Infrastructure.Cache
{
        ...
        IConsumer<EntityDeleted<TaxCategory>>
    {
        ...
        /// Key for caching
        /// </summary>
        public const string ALL_TAX_RATES_MODEL_KEY = "Nop.plugins.tax.fixedorbycountrystatezip.all";
        public const string ALL_TAX_RATES_PATTERN_KEY = "Nop.plugins.tax.fixedorbycountrystatezip";
