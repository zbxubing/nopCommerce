...
namespace Nop.Plugin.Tax.FixedOrByCountryStateZip
{
    ...
    /// </summary>
    public class FixedOrByCountryStateZipTxtProvider : BasePlugin, ITaxProvider
    {
        ...
        public FixedOrByCountryStateZipTxtProvider(ICountryStateZipService taxRateService,
