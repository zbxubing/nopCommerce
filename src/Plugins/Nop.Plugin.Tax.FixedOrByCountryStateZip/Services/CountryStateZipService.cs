...
namespace Nop.Plugin.Tax.FixedOrByCountryStateZip.Services
{
    ...
    public partial class CountryStateZipService : ICountryStateZipService
    {
        ...
        private const string TAXRATE_ALL_KEY = "Nop.fixedorbycountrystateziptaxrate.all-{0}-{1}";
        private const string TAXRATE_PATTERN_KEY = "Nop.fixedorbycountrystateziptaxrate.";
